...
<tr class="del<?php echo $id ?>">
	...
	<a class="btn btn" href="edit_candidate.php<?php echo '?id='.$id; ?>"><i class="icon-edit icon-large"></i>&nbsp;Edit</a>&nbsp;
...
<div class="modal hide fade" id="<?php echo htmlspecialchars($id); ?>">
  ...
  <div class="modal-footer" style="background-color: #fff; text-align: right; padding: 10px 20px;">
