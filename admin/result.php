...
while ($pos_row = mysqli_fetch_assoc($positions_query)) {
    ...
    $candidates = [];
    while ($row = mysqli_fetch_assoc($cand_query)) {
        $candidates[] = $row;
    }
...
<div class="chart-wrapper">
  ...
  <div class="chart-grid">
    <?php foreach ($candidates as $cand):
      $height_percent = ($max_votes > 0) ? ($cand['vote_count'] / $max_votes) * 100 : 0;
    ?>
    <div class="chart-item">
      <div class="chart-item-content">
        <div class="chart-pos"><?php echo htmlspecialchars($position); ?></div>
        ...
        <img src="<?php echo $cand['Photo']; ?>" class="chart-img" alt="<?php echo $cand['FirstName'] . ' ' . $cand['LastName']; ?>">
